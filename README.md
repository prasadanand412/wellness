...
<ul>
  <li> Go to 'Health Record Manager'</li>
  <li>Login/Sign Up</li>
  <li>Add required data such as Prescriptions, Reports or daily health data</li>
  <li>Track process and data and manage your data at one place</li>
</ul>
<li>For Symptom tracker:</li>
<ul>
  <li>Go to 'Symptoms Predictor'</li>
